export default class Pagination {
    ...
    <div class="siz">
    <img  data-element="nav-prev" class="imgP" src="./images/arrow-left.png" alt="arrow-left">
    </div>
    <div class="numbers" data-element="pagination">${this.getPages()}</div>
    <div class="siz">
    <img data-element="nav-next" class="imgP"  src="./images/arrow-right.png" alt="arrow-right">
    </div>
  </div>
    `
    }
